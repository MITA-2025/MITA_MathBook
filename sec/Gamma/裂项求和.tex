...
\Formula{分式裂项}{
    $\Forall{m_{1}\and m_{2}}{\bfZ}$ $m_{1}\ne m_{2}\implies$
    \Equation{
        \sum\frac{1}{\prod_{m=m_{1}}^{m_{2}}\braI{kn+m}}=\sum\frac{1}{m_{2}-m_{1}}\braII{\frac{1}{\prod_{m=m_{1}}^{m_{2}-1}\braI{kn+m}}-\frac{1}{\prod_{m=m_{1}+1}^{m_{2}}\braI{kn+m}}}\ .
    }
    作为推论, 我们有
    \begin{flalign*}
    ...
    \end{flalign*}
    \begin{flalign*}
        &\sum\frac{a^{2^{n}}}{1-a^{2^{n+1}}}=\sum\braII{\frac{1}{1-a^{2^{n}}}-\frac{1}{1-a^{2^{n+1}}}}\ .\quad\braI{a\ne1}&
    \end{flalign*}
...
\Formula{根式裂项}{
    ...
    \end{flalign*}
    \begin{flalign*}
        &\sum\frac{n-\sqrt{n^{2}-1}}{\sqrt{n\braI{n+1}}}=\sum\braII{\sqrt{\frac{n}{n+1}}-\sqrt{\frac{n-1}{n}}\,}\ .&
    \end{flalign*}
}
...
\Formula{差比数列前n项和}<差比数列前$\bm{n}$项和>{
    $\ForallII{k\and b}{\bfC}{q}{\bfC\setminus\braIII{1}}$
    \Equation{
...
\Formula{三角裂项}{
    ...
    \begin{flalign*}
        \sum\frac{1}{2^{n}}\tan\frac{\theta}{2^{n}}=-\frac{\rmd}{\rmd\theta}\ln\braIV{\prod\cos\frac{\theta}{2^{n}}}=-\frac{\rmd}{\rmd\theta}\ln\braIV{2^{-n}\prod\braII{\sin\frac{\theta}{2^{n-1}}\bigg/\sin\frac{\theta}{2^{n}}}}\ .&
    \end{flalign*}
}
...
\Formula{其它裂项}{
    ...
    \end{flalign*}
    \begin{flalign*}
        &\sum\frac{2}{\sqrt[3]{n^{2}-2n+1}+\sqrt[3]{n^{2}-1}+\sqrt[3]{n^{2}+2n+1}}=\sum\braII{\!\sqrt[3]{n+1}-\sqrt[3]{n}}\ ,&\\[-13mm]
    \end{flalign*}
    \begin{flalign*}
